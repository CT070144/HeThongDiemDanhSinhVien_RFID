...
import com.rfid.attendance.service.TokenIntrospectService;
import com.rfid.attendance.service.WebSocketSessionService;
...
public class SocketHandler {
    ...
    public void clientConnected(SocketIOClient client) {
        ...
        // Verify token
        var introspectResponse = tokenIntrospectService.introspect(token);
        ...
        if (introspectResponse.isValid()) {
            ...
            WebSocketSession webSocketSession = WebSocketSession.builder()
                    ...
                    .userId(introspectResponse.getUsername())
